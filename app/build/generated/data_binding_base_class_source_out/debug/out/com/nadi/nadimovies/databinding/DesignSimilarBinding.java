...
public final class DesignSimilarBinding implements ViewBinding {
  @NonNull
  ...
  private DesignSimilarBinding(@NonNull CardView rootView, @NonNull ShapeableImageView movieImg,
      @NonNull MaterialTextView movieNameTxt, @NonNull ShapeableImageView rateIcon,
  ...
  public static DesignSimilarBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.design_similar, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DesignSimilarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DesignSimilarBinding((CardView) rootView, movieImg, movieNameTxt, rateIcon,
          rateTxt);
    }
