...
public class DesignSimilarBindingImpl extends DesignSimilarBinding implements com.nadi.nadimovies.generated.callback.OnClickListener.Listener {
    ...
    public DesignSimilarBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }
    private DesignSimilarBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback1 = new com.nadi.nadimovies.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.movie == variableId) {
            ...
            setClickListener((com.nadi.nadimovies.ui.details.SimilarAdapter.OnClickListener) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setClickListener(@Nullable com.nadi.nadimovies.ui.details.SimilarAdapter.OnClickListener ClickListener) {
    ...
    protected void executeBindings() {
        ...
        com.nadi.nadimovies.ui.details.SimilarAdapter.OnClickListener clickListener = mClickListener;
