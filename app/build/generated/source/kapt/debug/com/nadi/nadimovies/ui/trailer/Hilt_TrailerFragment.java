...
public abstract class Hilt_TrailerFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TrailerFragment() {
    super();
  }

  Hilt_TrailerFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TrailerFragment_GeneratedInjector) this.generatedComponent()).injectTrailerFragment(UnsafeCasts.<TrailerFragment>unsafeCast(this));
    }
  }
