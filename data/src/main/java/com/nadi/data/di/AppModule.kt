...
object AppModule {
    ...
    fun provideTestDataGateway(movieAPIs: MovieAPIs): MovieGateway =
        MovieGatewayImplementer(movieAPIs)
//    fun provideTestDataGateway(): MovieGateway = MovieGatewayImplementer()

    @Singleton
    @Provides
    fun provideTrailerDataGateway(movieAPIs: MovieAPIs): TrailerGateway =
        TrailerGatewayImplementer(movieAPIs)

    @Singleton
    @Provides
    fun provideSimilarDataGateway(movieAPIs: MovieAPIs): SimilarGateway =
        SimilarGatewayImplementer(movieAPIs)
